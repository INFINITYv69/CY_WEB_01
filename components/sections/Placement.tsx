      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-16 mb-24">
          ...
          <div className="w-full lg:w-96">
            <div className="p-8 bg-gradient-to-b from-blue-50 to-sky-100/60 border-2 border-blue-500/20 rounded-3xl relative overflow-hidden group shadow-lg shadow-blue-900/5 hover:shadow-[0_18px_50px_rgba(59,130,246,0.25)] hover:border-blue-500 transition-all duration-300">
